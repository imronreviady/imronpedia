...
function hs_price($price = '0.00',$digits = 2) {
    global $hs;
    if (is_numeric($price) != true) {
        if ($hs['config']['curr_symbol_position'] == 'before') {
...
function hs_money($money = '0.00',$digits = 2) {
    return hs_price($money,$digits);
}

function hs_money_all($money = '0.00',$digits = 2) {
    global $hs;
